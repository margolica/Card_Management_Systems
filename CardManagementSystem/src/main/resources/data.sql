...
INSERT INTO users (
    ...
    birthday, gender, registration_date, role
      ...
      (
          ...
          '1990-05-12 00:00:00', 0, NOW(), 'ROLE_USER'
      ),
      (
          'anna_admin', 'secure456', 'anna@example.com', 'Анна', 'Петрова', 'Сергеевна',
          '1988-09-23 00:00:00', 1, NOW(), 'ROLE_ADMIN'
      );
...
INSERT INTO cards (client_id, pan_encrypted, pan_masked, validity_period, status, amount) VALUES
                                                                                              (1, '\\xDEADBEEF', '1234********5678', '2026-12-31 00:00:00', 'ACTIVE', 100000),
                                                                                              (2, '\\xCAFEBABE', '4321********8765', '2025-06-30 00:00:00', 'BLOCKED', 50000);

-- Добавление транзакций
INSERT INTO transactions (client_id, card_id, type, amount) VALUES
                                                                (1, 1, 'DEBIT', 5000),
                                                                (1, 1, 'CREDIT', 15000),
                                                                (2, 2, 'DEBIT', 2000);
